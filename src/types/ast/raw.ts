...
export type RawDialogueNode = Prettify<
  RawBaseNode & {
    type: "dialogue";
    rawSpeaker: string;
...
export type RawThoughtNode = Prettify<
  RawBaseNode & {
    type: "thought";
    rawSpeaker: string;
    rawText: string;
...
export type RawActionNode = Prettify<
  RawBaseNode & {
    type: "action";
    rawText: string;
  }
...
export type RawSystemNode = Prettify<
  RawBaseNode & {
    type: "system";
    rawText: string;
...
export type RawChoiceNode = Prettify<
  RawBaseNode & {
    type: "choice";
...
export type RawTransitionNode = Prettify<
  RawBaseNode & {
    type: "transition";
    rawTarget: string;
